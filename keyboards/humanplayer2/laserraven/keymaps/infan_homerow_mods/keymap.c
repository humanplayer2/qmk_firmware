...
__xxx__ = KC_NO,
  //
  // Homerow mods
SFT_T = (MT(MOD_RSFT,KC_T)),   // t, shift
SFT_N = (MT(MOD_RSFT,KC_N)),   // n, shift
CTL_S = (MT(MOD_RCTL,KC_S)),   // s, control
CTL_E = (MT(MOD_RCTL,KC_E)),   // e, control
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Q   , KC_Z  ,  AL_A   , KC_R   , CTL_S  , SFT_T  , KC_G   ,         KC_M   , SFT_N  , CTL_E  , KC_I   , AL_O   , DK_AA  , DK_OE  ,
